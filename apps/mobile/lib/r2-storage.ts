...
export async function uploadToR2(
  ...
  // Direct Cloudflare R2 public URL (works cross-platform)
...
export const getAvatarUrl = (userId: string, filename = 'avatar.jpg') => {
  // Direct Supabase URL for native apps
  return `https://your-project.supabase.co/storage/v1/object/public/avatars/${userId}/${filename}`
}
